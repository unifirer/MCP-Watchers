...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-19 (commit c8b1af3). Confidence: 98%.
...
- `tests/test_launcher_worktree_quoting.py` — 3 commits/90d
- `tests/test_watcher_allocator.py` — 3 commits/90d

### Code health
Three co-equal signals: defect risk 9.69/10 avg, hotspot health 7.68/10 (stable), worst `tests/test_launch_watcher.py` at 6.32/10 · maintainability 9.86/10 · performance risk 9 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
