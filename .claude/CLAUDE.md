...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-17 (commit e930bcb). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 9.17/10 avg, hotspot health 9.17/10 (stable), worst `###2.llm_fallback_proxy.py` at 4.73/10 · maintainability 9.46/10 · performance risk 3 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
