...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-18 (commit 0d24fc6). Confidence: 97%.
...
### Code health
Three co-equal signals: defect risk 9.64/10 avg, hotspot health 9.64/10 (stable), worst `###2.llm_fallback_proxy.py` at 6.29/10 · maintainability 9.76/10 · performance risk 4 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
