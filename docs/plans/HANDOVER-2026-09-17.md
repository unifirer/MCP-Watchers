...
**Updated:** 2026-09-17 — `mcpw-ybs.4`, `.5` and `.3` landed, and the `.2b` test
suite was found RED and fixed (see §2a). Read §2a before trusting any "green"
claim; read §5a before trusting the smoke test.
