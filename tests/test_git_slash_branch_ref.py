...
The defect no longer reproduces as of 2026-09-18 22:05 (git 2.55.0.windows.3,
NTFS), and the root cause was never identified. This module is the tripwire: if
the condition returns, these tests fail loudly instead of the branch silently
vanishing again. It exercises all three forms the bead recorded, in a throwaway
repository, and never touches the repository under test.
"""
import os
import shutil
import subprocess
